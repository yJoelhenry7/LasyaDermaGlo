...
export function Navbar() {
  ...
  return (
    <header className="fixed top-0 right-0 left-0 z-50">
      <div className="bg-sage-dark text-white">
        <div className="mx-auto flex max-w-7xl items-center justify-center gap-2 px-4 py-2 text-xs sm:px-6 sm:text-sm">
          <span className="text-white/75">Contact</span>
          <a
            href={phoneHref}
            className="inline-flex items-center gap-1.5 font-medium transition hover:text-sage-light"
          >
