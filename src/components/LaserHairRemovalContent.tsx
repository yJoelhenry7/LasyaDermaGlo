...
export function LaserHairRemovalContent() {
  const page = laserHairRemovalPage;
    ...
    <div className="mt-12 space-y-14 md:mt-14 md:space-y-16">
      ...
      <section className="border-t border-cream-dark pt-10">
        <h2 className="font-display text-2xl font-medium text-charcoal md:text-3xl">
          {page.beforeAfterGallery.title}
        </h2>
        <p className="mt-4 text-sm leading-relaxed text-warm-gray md:text-base">
          {page.beforeAfterGallery.intro}
        </p>
        <div className="mt-8">
          <BeforeAfterGallery
            items={[...page.beforeAfterGallery.items]}
            caption={page.beforeAfterGallery.caption}
          />
        </div>
      </section>
          ...
          <table className="min-w-full text-left text-sm">
            <thead className="bg-cream-dark/60 text-charcoal">
              <tr>
                ...
                <th className="px-4 py-3 font-medium">Price Range Per Session</th>
              </tr>
            </thead>
            <tbody>
