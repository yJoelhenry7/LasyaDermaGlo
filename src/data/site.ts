export const siteConfig = {
  ...
  description:
    "Derma Glo is a dermatology and aesthetic clinic in Rajahmundry offering acne care, laser hair removal, anti-aging treatments, Botox, fillers, and personalized skin health solutions.",
...
export const seoKeywords = [
  ...
  "best dermatologist in Rajahmundry",
  "skin clinic Rajahmundry",
  "dermatology clinic Rajahmundry",
  "cosmetologist Rajahmundry",
  "skincare clinic",
  "acne treatment Rajahmundry",
  "acne scar treatment",
  "laser hair removal Rajahmundry",
  "laser hair reduction",
  "laser skin treatment",
  "chemical peels Rajahmundry",
  "botox and fillers Rajahmundry",
  "anti-aging treatments Rajahmundry",
  "anti ageing clinic",
  "pigmentation treatment",
  "melasma treatment",
  "cosmetic dermatology",
  "skin rejuvenation",
  "hydrafacial Rajahmundry",
  "microneedling",
  "PRP therapy",
  "scar reduction",
  "skin brightening",
  ...
  "Dermaglo clinic",
  "Derma Glo",
  "Derma Glo Rajahmundry",
  "Dr G Lasya Priya",
  "Dr Lasya Priya dermatologist",
  "skin clinic near me Rajahmundry",
];
...
export const pageKeywords = {
  ...
  about: [
    ...
    "paediatric dermatology",
    "Derma Glo about",
    "skin doctor Rajahmundry",
  ],
  services: [
    "dermatology services Rajahmundry",
    "skin treatments Rajahmundry",
    "acne treatment",
    "laser hair removal",
    "botox fillers",
  ...
  antiAging: [
    "anti aging treatment Rajahmundry",
    "anti ageing clinic",
    "wrinkle treatment",
    "skin tightening",
  ...
  botox: [
    "botox Rajahmundry",
    "dermal fillers Rajahmundry",
    "wrinkle reduction",
    "lip fillers",
    "facial contouring",
    "injectables dermatologist",
  ],
  appointment: [
    "book dermatologist appointment Rajahmundry",
    "skin consultation",
    "Derma Glo appointment",
    "dermatology clinic booking",
  ],
  contact: [
    "Derma Glo contact",
    "dermatologist phone number Rajahmundry",
    "skin clinic address Rajahmundry",
    "Danivelpeta dermatologist",
  ],
  blog: [
    "skincare tips",
    "dermatology blog",
